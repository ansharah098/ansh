        ...
        <section>
            <div className="flex">
                <div className="  p-[50px]">
                 <img className="w-[700px] h-[700px]" src="Photo (2).png" alt="no image"
                 data-aos="fade-right" />
                </div>
                <div className="pt-[90px] pl-[3px]  pr-[80px]">
                <h1 className="font-bold text-2xl"> The Silky Vase </h1>
                <p className="text-xl pt-[10px]">$125</p>
